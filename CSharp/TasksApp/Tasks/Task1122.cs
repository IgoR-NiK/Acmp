...
namespace TasksApp.Tasks
{
	...
	///
	/// Требуется определить: может ли король выполнить ход из клетки с координатами (X1,Y1)
	...
	public static class Task1122
    {
        ...
        {
	        return Math.Abs(x1 - x2) <= 1 && Math.Abs(y1 - y2) <= 1 ? "YES" : "NO";
        }
